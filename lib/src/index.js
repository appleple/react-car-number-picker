...
export default (function (props) {
    ...
    return (React.createElement("div", { className: "car-number-picker car-number-step" + step, ref: picker },
        ...
        React.createElement(NumberPicker, { value: numbers.number1, open: step === 1, onOpen: function () {
                ...
                setStep(-1);
            }, disableds: ['0'], onChange: function (number1) {
        ...
        React.createElement(NumberPicker, { value: numbers.number2, disableds: numbers.number1 === '.' ? ['0'] : ['.'], open: step === 2, onOpen: function () {
                setStep(2);
            }, onClose: function () {
                setStep(-1);
        ...
        React.createElement(NumberPicker, { value: numbers.number3, disableds: numbers.number2 === '.' ? ['0'] : ['.'], open: step === 3, onOpen: function () {
                setStep(3);
            }, onClose: function () {
                setStep(-1);
        ...
        React.createElement(NumberPicker, { value: numbers.number4, disableds: numbers.number3 === '.' ? ['0', '.'] : ['.'], open: step === 4, onOpen: function () {
                setStep(4);
            }, onClose: function () {
                setStep(-1);
